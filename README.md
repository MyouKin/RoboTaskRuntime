...
- `include/tasks/spr_vision_26/`、`src/tasks/spr_vision_26/`：从 `spr_vision_26-main` 迁移来的 SPR 视觉任务。fake 测试任务默认构建，真实 Linux 硬件任务通过 CMake 选项启用。
...
SPR 视觉任务的迁移说明在 [src/tasks/spr_vision_26/README.md](/Users/myoukin/Codes/RoboTaskRuntime/src/tasks/spr_vision_26/README.md)。
